...
class VideoCutter(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        self.full_time_label = wx.StaticText(self.panel, label="Full Video Time (seconds):")
        self.full_time_text = wx.TextCtrl(self.panel, style=wx.TE_READONLY)
    ...
    def setup_layout(self):
        ...
        time_sizer.Add(self.full_time_label, 1, wx.EXPAND)
        time_sizer.Add(self.full_time_text, 2, wx.EXPAND)
        ...
        sizer.Add(time_sizer, 1, wx.EXPAND)
    ...
    def on_browse(self, event):
        ...
        if file_dialog.ShowModal() == wx.ID_OK:
            ...
            self.full_time_text.SetValue(str(video.duration))
        file_dialog.Destroy()
    ...
    def on_cut(self, event):
        ...
        if not video_path:
            ...
            try:
                ...
                wx.MessageBox(f"Video cut successfully. Output saved as '{output_path}'", "Success", wx.OK | wx.ICON_INFORMATION)
